"""Neuw Denim women’s jeans inventory scraper."""
...
LOG_PATH = BASE_DIR / "neuw_run.log"
FALLBACK_LOG_PATH = OUTPUT_DIR / "neuw_run.log"
...
def build_variant_rows(products: List[Dict[str, Any]]) -> List[Dict[str, str]]:
    ...
    for product in products:
        ...
        for edge in variants:
            ...
            inseam_label = determine_inseam_label(jean_style, variant_inseam)
...
def write_csv(rows: List[Dict[str, str]]) -> Path:
    ...
    output_path = OUTPUT_DIR / f"NEUW_{timestamp}.csv"
...
def main() -> None:
    LOGGER.info("Starting Neuw Denim scrape")
